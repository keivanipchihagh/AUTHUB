package swingWorkerExample;// Fig. 23.25: FibonacciNumbers.java
...
public class FibonacciNumbers extends JFrame {
    ...
    private final JButton goIfYouCanButton = new JButton("Go IF YOU CAN!");
    ...
    public FibonacciNumbers() {
        ...
        goIfYouCanButton.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent event) {
                        int n;
                        ...
                        fibonacciJLabel.setText(""+result);
        ...
        workerJPanel.add(goIfYouCanButton);
